...
export default function Navbar() {
  ...
  return (
    <div className="sticky top-2 z-50 flex items-center justify-between w-[60%] mx-auto rounded-xl mt-2 h-16 px-10 py-2 bg-white/10 backdrop-blur-sm border border-white/30 shadow-lg dark:bg-[#0A0A0A]/20 dark:border-gray-700">
      <Link
        href={"/"}
